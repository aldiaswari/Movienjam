...
class MovienjamRepository @Inject constructor(
    ...
    companion object {
        @Volatile
        private var instance: MovienjamRepository? = null
        ...
        fun getInstance(
            ...
            instance ?: synchronized(this) {
                instance ?: MovienjamRepository(remoteDataSource, localDataSource)
            }
    }
